...
$205$ in-scope cores the grammar does not reach (\S\ref{sec:census}) are partly executor coverage and partly true rearrangement.
...
resorcylic-macrolactone closure now registered (\S\ref{sec:guarantees}) but adding no reachable core---the
beam does not surface its highly-reducing program at practical width---so rung~3 stays open at a cost and
the reachable count is unchanged); and the $178$ of $205$ ($87\%$) that touch a hard family are exactly the
...
PT-domain regiochemistry classes & larger aromatic folds & rung 2 (predictive, PT-clade) \\
macrolactonization & resorcylic-acid lactones, macrocycles & rung 2 registered (reach unchanged); 3 open \\
...
outside the reachable set: the beam does not surface its program at practical width, \S\ref{sec:guarantees}.)
