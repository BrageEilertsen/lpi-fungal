...
\date{May 2026 --- draft v1.3 (inverse-compiler reframe)}
...
$7/106$), \code{make clustercad} and \code{make differential} (the differential probe),
...
6-MSA mining demo), \code{make figures} (Figures~\ref{fig:tiers}--\ref{fig:diff}), and
\code{make test} ($116$ tests). The six tagged milestones (\texttt{lpi-v0.2-cross-grammar} through
\texttt{lpi-v0.6-real-mining}), per-result numbers, scripts, and commits are tabulated in the
