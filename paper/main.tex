...
(Section~\ref{sec:manifold}): exact-match $9/326$, a core-match \emph{sensitivity} showing
...
closure's true increment is the beam-starved set ($+2$ cores, sound reach $9\to11$), not zero, and only the
...
operates over---exact reconstruction at $9/326$ is its \emph{boundary}---the sharp edge of the current grammar's reach, not a low score---the
