...
$H=\log 2$ to $H=0.01$ on held-out evaluation, with a complementary substrate channel cleanly
resolving label-distinguishable cases (isoterrein, asperlin) on the same corpus. The two engines do
