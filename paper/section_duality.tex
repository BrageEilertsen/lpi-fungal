...
registering the encoded PT closures lifts it cleanly to $11$ ($\mathrm{reach}\,9{\to}12$, zero demotions).
...
relative-completeness caveat of \S\ref{sec:guarantees} thus becomes a runnable per-core check.
