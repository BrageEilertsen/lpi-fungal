...
alone should suffice on bacterial systems (there are no label-symmetric walls to shatter),
and adding a structural rescue channel should be largely redundant.
...
index that the fungal architecture compresses away.
...
structural rescue channel does the temporal indexing that the bacterial sequence
...
conformation around the static synthase, and the structural-rescue channel is the only
