...
ESM $+$ verifier-pinned active count                 & $0.975$ & $107/118 = 0.907$ \\
\bottomrule
\end{tabular}
...
recovering $31/58$ silent-KR clusters where the cartoon scores $0/58$. The
verifier-pinned active count is an oracle headroom indicator, not a mass-derived
result. The substrate-only channel (cartoon) reaches its bacterial ceiling because
